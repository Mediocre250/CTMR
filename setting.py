...
class Setting:
    ...
    def parse(self):
        ...
        self.niche_threshold = args.niche_threshold
    ...
    def parse_arguments(self, parser):
        ...
        parser.add_argument('--hidden-dim', default=64, type=int, help='hidden dimensions to use')
        parser.add_argument('--weight_decay', default=0, type=float, help='weight decay regularization')
        parser.add_argument('--lr', default=0.0005, type=float, help='learning rate')  # 0.01
        parser.add_argument('--epochs', default=100, type=int, help='amount of epochs')  # 100
        parser.add_argument('--rnn', default='gru', type=str, help='the GRU implementation to use: [rnn|gru|lstm]')

        # data management
        parser.add_argument('--dataset', default='Foursquare_NYC.txt', type=str,
        ...
        parser.add_argument('--niche_threshold', default=0.8, type=float,
                            help='niche item threshold')

        # log
        parser.add_argument('--log_file', default='./logs/log_', type=str,
                            help='存储结果日志')
        parser.add_argument('--trans_loc_file', default='/home/djf/djf/POI/CDRF/pretrained/Foursquare_NYC/foursquare_scheme2_transe_loc_temporal_20.pkl', type=str,
        ...
        parser.add_argument('--trans_interact_file', default='/home/djf/djf/POI/CDRF/pretrained/Foursquare_NYC/foursquare_scheme2_transe_user-loc_20.pkl', type=str,
                            help='使用transh方法构造的空间POI转换图')
